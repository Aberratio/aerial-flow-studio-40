  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex mb-1",
        head_cell:
          "text-muted-foreground rounded-md w-8 h-8 sm:w-9 sm:h-9 font-normal text-xs sm:text-[0.8rem] flex items-center justify-center",
        ...
        day_today: "bg-primary/20 text-primary font-semibold border border-primary/30",
        day_outside:
