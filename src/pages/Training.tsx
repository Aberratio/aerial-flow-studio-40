      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {sessions.map((session) => (
            <Card key={session.id} className="glass-effect border-white/10 hover:border-white/20 transition-all group">
                ...
                {(user?.role === 'trainer' || user?.role === 'admin') && (
                  <div className="absolute top-2 left-2 opacity-0 group-hover:opacity-100 transition-opacity flex space-x-2">
                    ...
                    <Button
                      ...
                      className="bg-black/50 border-red-500/50 text-red-400 hover:bg-red-500/10"
                    >
