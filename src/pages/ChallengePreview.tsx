        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
            ...
            <div className="space-y-6">
              <div className="relative h-48 sm:h-56 lg:h-64 rounded-lg overflow-hidden bg-gradient-to-br from-purple-500/20 to-blue-500/20">
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  ...
                  <h1 className="text-2xl sm:text-3xl lg:text-3xl font-bold text-white line-clamp-2">{challenge.title}</h1>
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                <Card className="glass-effect border-white/10">
                  <CardContent className="p-3 sm:p-4 text-center">
                    ...
                    <div className="text-lg sm:text-xl font-bold text-white">{calculateDuration()}</div>
                  </CardContent>
                </Card>
                ...
                <Card className="glass-effect border-white/10">
                  <CardContent className="p-3 sm:p-4 text-center">
                    ...
                    <div className="text-lg sm:text-xl font-bold text-white">{challenge.participants_count?.toLocaleString() || '0'}</div>
                  </CardContent>
                </Card>
                ...
                <Card className="glass-effect border-white/10">
                  <CardContent className="p-3 sm:p-4 text-center">
                    ...
                    <Badge className={`mt-1 ${getDifficultyColor(challenge.difficulty_level || 'intermediate')}`}>
                ...
                <Card className="glass-effect border-white/10">
                  <CardContent className="p-3 sm:p-4 text-center">
                    ...
                    <div className="text-xs sm:text-sm text-muted-foreground">Training Days</div>
                    <div className="text-lg sm:text-xl font-bold text-white">{challenge.training_days?.length || 0}</div>
                  </CardContent>
                </Card>
              </div>
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <Badge className="bg-purple-500/20 text-purple-400">
                        {completedDays.size} of {challenge.training_days?.length || 0}
                      </Badge>
                    </div>
                    <div className="mb-3">
                      <div className="flex justify-between text-sm text-muted-foreground mb-1">
                        <span>Days Completed</span>
                        <span>{Math.round((completedDays.size / (challenge.training_days?.length || 1)) * 100)}%</span>
                      </div>
                      <Progress value={(completedDays.size / (challenge.training_days?.length || 1)) * 100} className="h-2" />
                    </div>
              ...
              <Card className="glass-effect border-white/10">
                <CardHeader>
                  <CardTitle className="text-white text-lg">Challenge Rules</CardTitle>
                </CardHeader>
                <CardContent className="space-y-3">
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-purple-400 rounded-full flex-shrink-0"></div>
                    <span className="text-muted-foreground text-sm">Complete training sessions in order</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-purple-400 rounded-full flex-shrink-0"></div>
                    <span className="text-muted-foreground text-sm">Follow rest days as scheduled</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-purple-400 rounded-full flex-shrink-0"></div>
                  ...
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-purple-400 rounded-full flex-shrink-0"></div>
                    <span className="text-muted-foreground text-sm">Earn achievements by completing milestones</span>
                  </div>
                </CardContent>
              </Card>
            </div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-1">
                          <h3 className={`font-semibold text-sm sm:text-base truncate ${isAccessible ? 'text-white' : 'text-gray-400'}`}>
                        ...
                        <p className={`text-xs sm:text-sm ${isAccessible ? 'text-muted-foreground' : 'text-gray-500'}`}>
                        ...
                        {trainingDay.description && (
                          <p className={`text-xs mt-1 line-clamp-2 ${isAccessible ? 'text-gray-300' : 'text-gray-500'}`}>
                            {trainingDay.description}
                          </p>
                        )}
                      </div>
